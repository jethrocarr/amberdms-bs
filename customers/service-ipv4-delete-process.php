<?php
/*
	customers/service-ipv4-delete-process.php

	access:	customers_write

	Deletes the selected IPv4 address from a customer. However this does not
	remove any associated data records.
*/
