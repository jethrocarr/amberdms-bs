...
my $opt_tmpfile = "/tmp/billing_system_mysqlquery";

# location of install schema
my $opt_schemadata;
if ($0 =~ /^([\S\s]*)\/resources\/autoinstall.pl$/)
{
	$opt_schemadata = "$1/schema/";
}
else
{
	$opt_schemadata = "../schema/";
}
...
print "\n";
print "This script setups the Amberdms Billing System database components:\n";
print " * Amberdms Billing System MySQL user\n";
