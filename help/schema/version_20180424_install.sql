...
CREATE DATABASE `amberdms_dev` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `amberdms_dev`;
...
CREATE TABLE `account_quotes` (
  ...
  `amount` decimal(11,2) NOT NULL DEFAULT '0.00',
  `notes` text NOT NULL,
  `terms_of_business` varchar(20) NOT NULL DEFAULT 'terms_none',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `projects` (
  ...
  `project_quote` VARCHAR(50) NOT NULL,
  `date_start` date NOT NULL DEFAULT '0000-00-00',
  `date_end` date NOT NULL DEFAULT '0000-00-00',
...
-- Dump completed on 2014-01-01 18:33:14
