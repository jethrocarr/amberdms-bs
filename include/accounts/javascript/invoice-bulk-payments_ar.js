/*
 * 	invoice-bulk-payments_ar.js
 * 	
 * 	Javascript functions for accounts/ar/invoice-bulk-payments.php
 */
...
{
	$.get("accounts/ajax/get_amount_due_ar.php", {id: id}, function(amount)
	{
