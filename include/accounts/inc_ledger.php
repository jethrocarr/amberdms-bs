...
/*
	...
	1		success
*/	
function ledger_trans_add($mode, $type, $customid, $date_trans, $chartid, $amount, $memo, $source)
{
	log_debug("inc_ledger", "ledger_trans_add($mode, $type, $customid, $date_trans, $chartid, $amount, $memo, $source)");
