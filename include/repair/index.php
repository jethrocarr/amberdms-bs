...
<?php
/*
	include/repair/index.php

	Will execute the selected repair script and execute against hosted or standalone environments.

	(shamelessly stolen from include/cron/index.php script)
*/
