...
class page_output
{
	...
	function execute()
	{
		...
		*/
		...
		$this->obj_sql_ar_invoice->string	= "SELECT id, active, template_file, template_name, template_description FROM templates WHERE template_type IN('ar_invoice_tex', 'ar_invoice_htmltopdf') ORDER BY template_name";
