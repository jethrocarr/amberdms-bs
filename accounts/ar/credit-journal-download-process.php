<?php
/*
	accounts/ar/credit-journal-download-process.php
	...
	*/
	...
	else
	{
		...
		else
		{
			...
			$invoiceid = sql_get_singlevalue("SELECT customid as value FROM journal WHERE journalname='account_ar_credit' AND id='$journalid'");
