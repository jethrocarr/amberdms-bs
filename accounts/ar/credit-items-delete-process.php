<?php
/*
	accounts/ar/credit-items-delete-process.php
...
if (user_permissions_get('accounts_ar_write'))
{
	...
	*/
	...
	$returnpage_error	= "accounts/ar/credit-items.php";
	$returnpage_success	= "accounts/ar/credit-items.php";

	invoice_form_items_delete_process("ar_credit", $returnpage_error, $returnpage_success);
}
else
{
