...
class page_output
{
	...
	function page_output()
	{
		...
		$this->obj_menu_nav->add_item("Credit Payments/Refund", "page=accounts/ar/credit-payments.php&id=". $this->id ."");
	...
	function execute()
	{
		...
		$this->obj_table_items->type		= "ar_credit";
		$this->obj_table_items->invoiceid	= $this->id;
		$this->obj_table_items->page_view	= "accounts/ar/credit-items-edit.php";
		$this->obj_table_items->page_delete	= "accounts/ar/credit-items-delete-process.php";
	...
	function render_html()
	{
		...
		credit_render_invoiceselect("ar_credit", $this->id, "accounts/ar/credit-items-edit.php");
