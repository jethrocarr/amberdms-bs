...
class page_output
{
	...
	function page_output()
	{
		...
		$this->obj_menu_nav->add_item("Credit Journal", "page=accounts/ar/journal.php&id=". $this->id ."");
	...
	function execute()
	{
		...
		$this->obj_form_credit->processpage	= "accounts/ar/credit-delete-process.php";
