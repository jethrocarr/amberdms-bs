<?php
/*
	accounts/ap/invoices-items-add-process.php
...
if (user_permissions_get('accounts_ap_write'))
{
	...
	*/
	...
	$returnpage_error	= "accounts/ap/invoice-items.php";
	$returnpage_success	= "accounts/ap/invoice-items-edit.php";

	invoice_form_items_add_process("ap", $returnpage_error, $returnpage_success);
}
else
{
