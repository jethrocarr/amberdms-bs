<?php
/*
	accounts/ap/credit-items-edit-process.php
...
if (user_permissions_get('accounts_ap_write'))
{
	...
	*/
	...
	$returnpage_error	= "accounts/ap/credit-items-edit.php";
	$returnpage_success	= "accounts/ap/credit-items.php";

	invoice_form_items_process("ap_credit", $returnpage_error, $returnpage_success);
}
else
{
