<?php
/*
	accounts/ap/credits-items-edit.php
					...
					case "product":
						...
						if ($sql_tax_obj->num_rows())
						{
							...
							foreach ($sql_tax_obj->data as $data_tax)
							{
								...
								$sql_cust_tax_obj->string	= "SELECT id FROM vendors_taxes WHERE vendorid='". $this->credit->data["vendorid"] ."' AND taxid='". $data_tax["taxid"] ."'";
