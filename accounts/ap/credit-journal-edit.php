<?php
/*
	accounts/ap/credit-journal_edit.php
...
class page_output
{
	...
	function execute()
	{
		...
		*/
		...
		$this->obj_form_journal->prepare_set_journalname("account_ap_credit");
		...
		$this->obj_form_journal->prepare_set_form_process_page("accounts/ap/credit-journal-edit-process.php");
	}
