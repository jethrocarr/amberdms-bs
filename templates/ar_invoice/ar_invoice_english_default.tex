...
%% foreach taxes
%% (name\_tax) & (taxnumber) \tabularnewline
%% end
%% if customer\_tax\_number
%% Customer Tax ID  & (customer\_tax\_number) \tabularnewline
%% end
\end{tabular}
...
%% if code\_ordernumber
%% \textbf{Order No} & (code\_ordernumber) \tabularnewline
%% end
%% if code\_ponumber
%% \textbf{PO No} & (code\_ponumber) \tabularnewline
%% end
